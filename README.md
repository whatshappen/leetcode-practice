...
      <font color=DimGray>例如：“hello”输出 ‘h’ ，	“abbac”输出 ‘c’ ，“abdabe”输出 ‘d’</font>
...
      	<font color="#666666">例如：int[] array = {-1,0,0,2,4,4,4,6};</br>
      	返回长度为：5，打印结果为：-1，0，2，4，6</font>
...
      	<font color="#666666">例如：已知int[] nums = [3, 5, 7,11, 15], target = 10，返回符合条件的索引。</br>
      	nums[0] + nums[2] = 3 + 7 = 10,nums[1]+nums[1]=10;因为nums相同索引只能使用一次，所以返回[0, 1]</font>
...
      	<font color="#666666">例如：["flower","flow","flight"] 返回：fl；["dog","racecar","car"] 返回：“”</font>
...
      	<font color="#666666">例如：[3，4，2，3] 返回：false；[3,6,4,5] 返回：true；[4,2,3] 返回true；</font>
...
      	<font color="#666666">例如：已知int num = 123,结果为321，如果超出范围返回0</font>
...
      	<font color="#666666">例如：int num = 121,结果为true；int num = -121,结果为false；int num = 12,结果为false；</font>
...
      	<td height=30px>将罗马数字转成对应的int类型数据。对应关系如下：</br>
	...
	D =>  500</br>
	M =>  1000</br>
      	<font color="#666666">例如：输入“III”，输出：3，输入“IV”，输出：4，输入“IX”，输出：9，输入“LVIII，输出：58(L=50,V=5,III=3)，输入“CMMXCIV”，输出：1994(M=1000,CM=900,XC=90,IV=4)</font>
