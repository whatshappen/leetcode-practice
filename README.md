...
<table align="center" border="1" cellspacing="0" width="100%">
	<caption height=60px; style="font-size:20px; text-aligin:center; align:center;">算法题整理</caption>
	<tr>
		<td width="20%"; height=30px;  rowspan="2"; style="background-color:#ededed;text-align:center";>数据去重</td>
